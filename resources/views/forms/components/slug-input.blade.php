...
>
    <div
            x-data="{
            operation: '{{ $getOperation() }}', // edit or create
            ...
            @else
                ...
                >
                    ...
                    <a
                            href="#"
                            role="button"
                            title="{{ trans('filament-title-and-slug::title-and-slug.permalink_action_edit') }}"
                        ...
                        "
                            :class="operation !== 'create' && modified ? 'text-gray-600 bg-gray-100 dark:text-gray-400 dark:bg-gray-700 px-1 rounded-md' : ''"
                    >
                        ...
                        <span class="sr-only">{{ trans('filament-title-and-slug::title-and-slug.permalink_action_edit') }}</span>
                    ...
                    <span x-show="!editing && operation !== 'create' && modified"> [{{ trans('filament-title-and-slug::title-and-slug.permalink_status_changed') }}]</span>
                ...
                >
                    ...
                    <input
                            ...
                            {{ $getExtraInputAttributeBag()->class(['block w-full transition duration-75 rounded-lg shadow-sm focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600 disabled:opacity-70 dark:bg-gray-700 dark:text-white border-gray-300' => !$errors->has($getStatePath()), 'dark:border-gray-600' => !$errors->has($getStatePath()), 'border-danger-600 ring-danger-600' => $errors->has($getStatePath())]) }}
                    />
                ...
                >
                    ...
                    <a
                        ...
                        "
                    >
                        {{ trans('filament-title-and-slug::title-and-slug.permalink_action_ok') }}
                    </a>

                    <x-filament::link
                            x-show="operation === 'edit' && modified"
                            x-on:click="resetModification()"
                            class="cursor-pointer ml-4"
                            icon="heroicon-o-arrow-path"
                            color="gray"
                            size="sm"
                            title="{{ trans('filament-title-and-slug::title-and-slug.permalink_action_reset') }}"
                    >
                        <span class="sr-only">{{ trans('filament-title-and-slug::title-and-slug.permalink_action_reset') }}</span>
                    </x-filament::link>
                    ...
                    <x-filament::link
                            ...
                            color="gray"
                            size="sm"
                            title="{{ trans('filament-title-and-slug::title-and-slug.permalink_action_cancel') }}"
                    >
                        <span class="sr-only">{{ trans('filament-title-and-slug::title-and-slug.permalink_action_cancel') }}</span>
                    </x-filament::link>

                </div>

                <span
                        x-show="operation === 'edit'"
